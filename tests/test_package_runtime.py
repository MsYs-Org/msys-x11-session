...
class CanonicalManifestTests(unittest.TestCase):
    ...
    def test_native_debug_gesture_cli_is_packaged_without_xdotool(self) -> None:
        ...
        self.assertIn("--debug-drag-identity", source)
        self.assertIn("DEBUG_DRAG_HOLD_MS 650", source)
        self.assertIn("debug_gesture_hold_ms_for_option", source)
        self.assertIn("gesture_duration, gesture_hold_ms", source)
